...
## 1. Simplicity Check (`.opencode/rules/structure.md`)
...
## 2. Completeness Check (`.opencode/rules/completeness.md`)
...
## 3. Correctness Check (`.opencode/rules/correctness.md`)
...
## 4. Style Check (`.opencode/rules/style.md`)

- Matches existing project style?
- Formatter would pass? (Prettier, ruff, gofmt, etc.)
- Imports at top?

## 5. Naming Check (`.opencode/rules/naming.md`)
...
## 6. Performance Check (`.opencode/rules/performance.md`)

- N+1 queries in loops?
- Unnecessary allocation inside loops?
- Eager loading when lazy would do?

## 7. Testability Check (`.opencode/rules/testability.md`)

- Logic testable without excessive mocking?
- Side effects isolated?

## 8. Async Check (`.opencode/rules/async.md`)
